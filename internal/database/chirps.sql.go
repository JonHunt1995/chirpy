...
func (q *Queries) GetAllChirpsFromAuthor(ctx context.Context, userID uuid.NullUUID) ([]Chirp, error) {
...
func (q *Queries) GetChirpAuthor(ctx context.Context, id uuid.UUID) (uuid.NullUUID, error) {
